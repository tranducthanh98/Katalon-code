...
WebUI.delay(10)
WebUI.click(findTestObject('Object Repository/User page/radioCreateNew'))
WebUI.click(findTestObject('Object Repository/User page/btn_Next'))
// set login name and Email Address
WebUI.setText(findTestObject('Object Repository/User page/Manage Login Page/txt_Login Name'),"Automation create login")
WebUI.setText(findTestObject('Object Repository/User page/Manage Login Page/txt_Email Address'),"tppttran@alarm.com")

// select Vendor role
WebUI.selectOptionByValue(findTestObject('Object Repository/User page/Manage Login Page/Role_Custom'),'999993', false) 
// save 
WebUI.click(findTestObject('Object Repository/User page/Manage Login Page/btn-Save'))
if(WebUI.verifyElementChecked(findTestObject('Object Repository/User page/Manage Login Page/btn-Save'), 20)) {
